...
parser.add_argument("--mdps_window", type=int, default=24)
parser.add_argument("--hf_kc", type=float, default=0.3)
...
model.mdps_window = args.mdps_window 
model.hf_kc = args.hf_kc
